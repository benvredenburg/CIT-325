...
-- Create logger table and logger_s sequence.
CREATE TABLE logger
...
-- Append log file.
SPOOL apply_plsql_lab11.txt append;
...
-- Describe result of previous step.
DESC manage_item

-- Close log file.
SPOOL OFF

-- Implement the manage_item package body.
...
-- Create item_trig trigger for INSERT and UPDATE
...
-- Delete a row from the common_lookup table where the column_lookup_table is ITEM, the common_lookup_column is ITEM_TYPE, and the common_lookup_type is BLU-RAY.
...
-- Write three INSERT statements that test the three conditions of your inserting event trigger.
INSERT INTO item
VALUES
( item_s1.NEXTVAL
, 'B01IHVPA8'
...
-- Verify item_trig trigger's INSERT event works.
COL item_id        FORMAT 9999 HEADING "Item|ID #"
COL item_title     FORMAT A20  HEADING "Item Title"
COL item_subtitle  FORMAT A20  HEADING "Item Subtitle"
COL item_rating    FORMAT A6   HEADING "Item|Rating"
...
-- Verify the results of the logger table.
COL logger_id       FORMAT 9999 HEADING "Logger|ID #"
COL old_item_id     FORMAT 9999 HEADING "Old|Item|ID #"
COL old_item_title  FORMAT A20  HEADING "Old Item Title"
COL new_item_id     FORMAT 9999 HEADING "New|Item|ID #"
...
-- Update the Star Wars row that you previously inserted into the item table to test your updating event trigger.
UPDATE item
...
-- Verify that your item_trig trigger’s update event works by querying the modified results again.
COL item_id        FORMAT 9999 HEADING "Item|ID #"
COL item_title     FORMAT A20  HEADING "Item Title"
COL item_subtitle  FORMAT A20  HEADING "Item Subtitle"
COL item_rating    FORMAT A6   HEADING "Item|Rating"
...
-- Verify the calues in the item table after the deletion of the row.
COL item_id        FORMAT 9999 HEADING "Item|ID #"
COL item_title     FORMAT A20  HEADING "Item Title"
COL item_subtitle  FORMAT A20  HEADING "Item Subtitle"
COL item_rating    FORMAT A6   HEADING "Item|Rating"
