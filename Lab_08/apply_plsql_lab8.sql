...
-- Show a description of the package.
DESC contact_package

-- Close log file.
SPOOL OFF

-- Create a contact_package package body that implements two insert_contact procedures.
...
--  Recreate the contact_package package body by converting the insert_contact procedures into overloaded functions.
